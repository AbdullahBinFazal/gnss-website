    ...
    <section className={styles.hero}>
      ...
      <div className={styles.heroContent}>
        ...
        <Paragraph className={styles.heroDescription}>
          The lab builds national and international relationships that support joint research, instrument deployment, academic exchange, training, data sharing and technology development.
        </Paragraph>
      </div>
    </section>
  );
