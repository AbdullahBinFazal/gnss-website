...
const researchDomains = [
  ...
  { id: 2, title: "Domain 2 – Education & Training", description: "This Application domain focuses on the education and specialized trainings related to space science & technology and GNSS. Several education programs, including degree programs will be run throughout the year to develop specialized human resource in the domains of Space Science & Technology and GNSS.", icon: "🎓", image: "https://images.unsplash.com/photo-1509062522246-3755977927d7?w=800&h=500&fit=crop&crop=center" },
