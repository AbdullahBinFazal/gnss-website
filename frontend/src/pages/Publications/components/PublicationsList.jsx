...
const publications = [
  ...
  { id: 7, title: "GNSS TEC based Ionosphere Anomalies Related to the 2019 Mw 6.2 Thailand Earthquake", authors: "Shireen Mushtaq, Rimsha Ashraf, Dr. Munawar Shah, Punyawi Jamjareegulgran", journal: "ICASE 2021 Proceedings", year: 2021, type: "Conference Paper", category: "Seismo-Ionospheric", link: "https://ncgsa.org.pk/wp-content/uploads/2025/06/ICASE-2021-Proceedings.pdf#84", abstract: "This paper investigates GNSS TEC-based ionosphere anomalies related to the 2019 Mw 6.2 Thailand Earthquake.", image: "https://media.gettyimages.com/id/1249929729/photo/core-module-of-chinas-space-station-tianhe-orbiting-earth.jpg?s=612x612&w=0&k=20&c=BjiDbFD1ZXh8nCI5L7wRhu9gq885VV22v5oETO_V9gc=" },
  { id: 8, title: "Investigation of Seismo Ionospheric Anomalies Associated with the Mw 6.7 Mongolia Earthquake", authors: "Shireen Mushtaq, Rimsha Ashraf", journal: "ICASE 2021 Proceedings", year: 2021, type: "Conference Paper", category: "Seismo-Ionospheric", link: "https://ncgsa.org.pk/wp-content/uploads/2025/06/ICASE-2021-Proceedings.pdf#84", abstract: "This paper investigates seismo-ionospheric anomalies associated with the Mw 6.7 Mongolia Earthquake using GNSS TEC data.", image: "https://media.gettyimages.com/id/165773692/photo/satellite-and-earth.jpg?s=612x612&w=0&k=20&c=Vlp5tQzJyqBIUxtqvHZ5MvAOHPjPo0LeozGo9wjAKfk=" },
  { id: 9, title: "Possible Seismo-Ionospheric Anomalies Associated with the Earthquakes Occurred in 2018 Using GNSS TEC: A Statistical Analysis", authors: "Muhammad Arqim Adil, Munawar Shah, Asim Khan, Ejaz Nazir, Mohamed Freeshah, Hamza Bin Babar", journal: "ICASE 2021 Proceedings", year: 2021, type: "Conference Paper", category: "Seismo-Ionospheric", link: "https://ncgsa.org.pk/wp-content/uploads/2025/06/ICASE-2021-Proceedings.pdf#84", abstract: "Statistical analysis of possible seismo-ionospheric anomalies associated with earthquakes in 2018 using GNSS TEC data.", image: "https://media.gettyimages.com/id/2206773305/photo/satellite-in-space-station-orbiting-earth-providing-communication-internet-connection-coverage.jpg?s=612x612&w=0&k=20&c=LUimbBcDRewwUbzKTMLfFhxhWqm_bwjajUVSLpkTtu8=" },
  { id: 10, title: "Establishment of National Center of GIS & Space Applications: The First Step towards achieving the UN SDGs through Space", authors: "Dr. Najam Naqvi, Dr. Salma Zainab Farooq, Usama Ahmed, Daniyal Raza Kazmi", journal: "IAF Space Education and Outreach Symposium (IAC-24)", year: 2024, type: "Conference Paper", category: "NCGSA", link: "https://iafastro.directory/iac/archive/browse/IAC-24/E1/IP/91021/", abstract: "This paper shares the success story of establishing NCGSA at Pakistan to achieve UN SDGs through space science, technology and its applications.", image: "https://media.gettyimages.com/id/1609597622/photo/satellite-internet-communication-from-space.jpg?s=612x612&w=0&k=20&c=sZWPgtH8lFsOYNCzmpissHgUyYCJOqPK9SeTXZutqYU=" },
  { id: 11, title: "Modeling and Simulation of BSAR System Using Reflected BeiDou B11 Signals", authors: "Hassan Sadiq, Muhammad Shoaib ul Hassan, Muhammad Usman", journal: "ICASE 2021 Proceedings", year: 2021, type: "Conference Paper", category: "GNSS Applications", link: "https://ncgsa.org.pk/wp-content/uploads/2025/06/ICASE-2021-Proceedings.pdf#84", abstract: "This paper presents modeling and simulation of Bi-Static Synthetic Aperture Radar using reflected BeiDou B11 signals.", image: "https://media.gettyimages.com/id/96376746/photo/satellite-with-solar-panels-above-earth.jpg?s=612x612&w=0&k=20&c=bn_DeXGOFrt48Q-gJ_e3l_B7S1AhaVZQjf7UiwVkLqU=" },
    ...
    <div className={styles.cardContent}>
      <div className={styles.cardHeader}>
        ...
        <div className={styles.cardMeta}>
          ...
          <span className={styles.typeTag} style={{ background: pub.type === "Journal Paper" ? "rgb(243, 248, 245)" : "rgb(255, 255, 255)", color: pub.type === "Journal Paper" ? "#000000" : "#000000" }}>
            {pub.type}
          </span>
          {pub.link && (
