      ...
      <div className="container">
        <div className={styles.card}>
          ...
          <div className={styles.content}>
            <h2 className={styles.title}>🛰️ <span className={styles.gradientText}>GNSS Research Lab</span></h2>
            <p className={styles.cardDescription}>The GNSS Research Lab, established in 2020 under the National Center of GIS and Space Applications (NCGSA), is equipped with cutting-edge GNSS receivers and equipment. It serves as a specialized hub for advanced research and innovation in satellite navigation.</p>
